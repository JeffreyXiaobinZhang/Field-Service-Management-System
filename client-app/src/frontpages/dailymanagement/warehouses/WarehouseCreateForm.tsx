...
const WarehouseCreateForm: React.FC<RouteComponentProps> = ({
  match,
  history
}) => {
  ...
  const handleSubmit = () => {
      createWarehouse(warehouse).then(() => history.push(`/dailymanagement/warehouse`));
  };
...
export default observer(WarehouseCreateForm);
